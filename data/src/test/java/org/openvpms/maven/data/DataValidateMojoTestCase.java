...
/**
 * Tests the {@link DataValidateMojo} class.
 *
 * @author <a href="mailto:support@openvpms.org">OpenVPMS Team</a>
 * @version $LastChangedDate$
 */
public class DataValidateMojoTestCase extends AbstractMojoTestCase {
    ...
    public void testMojoLookup() throws Exception {
        ...
        DataValidateMojo mojo = (DataValidateMojo) lookupMojo("validate", pluginXml);
        assertNotNull(mojo);
    }
