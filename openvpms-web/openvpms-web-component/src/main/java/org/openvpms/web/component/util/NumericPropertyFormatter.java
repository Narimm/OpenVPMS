...
public class NumericPropertyFormatter {
    ...
    public static NumberFormat getFormat(Property property, boolean edit) {
        ...
        if (property.isMoney()) {
            ...
            format = (edit) ? NumberFormatter.getFormat(NumberFormatter.DECIMAL_EDIT)
                            : NumberFormatter.getFormat(NumberFormatter.DECIMAL_VIEW);
        } else {
            format = (edit) ? NumberFormatter.getFormat(NumberFormatter.INTEGER_EDIT)
                            : NumberFormatter.getFormat(NumberFormatter.INTEGER_VIEW);
        }
        return format;
    }
