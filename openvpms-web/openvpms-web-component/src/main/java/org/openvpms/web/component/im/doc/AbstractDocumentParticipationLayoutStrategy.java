...
public abstract class AbstractDocumentParticipationLayoutStrategy implements IMObjectLayoutStrategy {
    ...
    /**
     * Determines if the document description should be displayed.
     */
    private final boolean showDescription;


    /**
     * Constructs an {@link AbstractDocumentParticipationLayoutStrategy}
     *
     * @param showDescription if {@code true display both document name and description
     */
    public AbstractDocumentParticipationLayoutStrategy(boolean showDescription) {
