...
/**
 * An editor for <em>entityLink.reminderCountTemplate</em> archetypes, that constrains templates to patient letters
 * and forms.
 *
 * @author Tim Anderson
 */
public class ReminderCountTemplateEditor extends EntityLinkEditor {
    ...
    /**
     * Constructs an {@link ReminderCountTemplateEditor}.
     *
     * @param relationship the link
     * @param parent       the parent object
     * @param context      the layout context
     */
    public ReminderCountTemplateEditor(EntityLink relationship, IMObject parent, LayoutContext context) {
    ...
    protected IMObjectReferenceEditor<Entity> createReferenceEditor(Property property, LayoutContext context) {
        DocumentTemplateReferenceEditor editor = new DocumentTemplateReferenceEditor(property, getParent(), context,
                                                                                     true);
        editor.setTypes(PatientArchetypes.DOCUMENT_LETTER, PatientArchetypes.DOCUMENT_FORM);
        return editor;
    }
}
