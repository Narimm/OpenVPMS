 ...
 * @author Tim Anderson
 */
public class SMSAppointmentTemplateEditor extends AbstractIMObjectEditor {

    /**
     * The appointment reminder sampler.
     */
    private SMSApppointmentTemplateSampler sampler;
    ...
    public SMSAppointmentTemplateEditor(Entity object, IMObject parent, LayoutContext layoutContext) {
        ...
        sampler = new SMSApppointmentTemplateSampler(getLayoutContext());
        sampler.setTemplate(object);
        ...
        getProperty("expression").addModifiableListener(listener);
        getProperty("expressionType").addModifiableListener(listener);
        updateSampler();
    }
    ...
    private class LayoutStrategy extends SMSAppointmentTemplateLayoutStrategy {
