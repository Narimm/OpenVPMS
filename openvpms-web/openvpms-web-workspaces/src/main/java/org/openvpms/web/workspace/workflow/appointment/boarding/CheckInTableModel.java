 ...
 * Displays a message if there are no check-ins on the date.
 *
 * @author Tim Anderson
 */
public class CheckInTableModel extends CheckInOutTableModel {
     ...
     */
    public CheckInTableModel(AbstractMultiDayScheduleGrid grid, Context context, ScheduleColours colours) {
    ...
    protected EmptyTableRenderer createEmptyTableCellRenderer() {
        return new EmptyTableRenderer("workflow.scheduling.appointment.checkin.none");
    }
}
