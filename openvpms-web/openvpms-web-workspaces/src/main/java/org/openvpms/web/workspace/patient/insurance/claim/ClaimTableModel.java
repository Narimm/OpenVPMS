...
/**
 * Table model for <em>act.patientInsuranceClaim</em>.
 *
 * @author Tim Anderson
 */
public class ClaimTableModel extends DescriptorTableModel<Act> {
     ...
     */
    public ClaimTableModel(String[] shortNames, LayoutContext context) {
    ...
    protected ArchetypeNodes getArchetypeNodes() {
        return allSimpleNodesMinusIdAndLongText().exclude("policy");
    }
}
