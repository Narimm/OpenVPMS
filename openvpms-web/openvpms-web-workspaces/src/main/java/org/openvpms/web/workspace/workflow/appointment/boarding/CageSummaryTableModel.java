...
/**
 * Table model for appointments that span multiple days where the appointments are grouped by cage type, and
 * are summarised.
 *
 * @author Tim Anderson
 */
public class CageSummaryTableModel extends CageTableModel {
     ...
     */
    public CageSummaryTableModel(ScheduleEventGrid grid, Context context, ScheduleColours colours) {
