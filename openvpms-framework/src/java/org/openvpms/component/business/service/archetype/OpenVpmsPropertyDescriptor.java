 ...
 */
public class OpenVpmsPropertyDescriptor extends OpenVpmsDescriptor implements
        IPropertyDescriptor {
     ...
     * 
     */
    public OpenVpmsPropertyDescriptor(IPropertyDescriptor descriptor) {
        this(descriptor.getPropertyType());
        copyFrom(descriptor);
    }

    public OpenVpmsPropertyDescriptor(Class type) {
        super(type);
    }

    public OpenVpmsPropertyDescriptor(String name, Class type) {
        this(type);
        this.name = name;
        setDisplayName(name);
    }
    ...
    @Override
    public Object clone() {
        return new OpenVpmsPropertyDescriptor(this);
    }
    ...
    /**
     * @return Returns the lookupShortName.
     */
    ...
    /**
     * @param lookupShortName
     *            The lookupShortName to set.
     */
