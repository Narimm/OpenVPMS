 ...
 *
 *  $Id: AuditServiceException.java 310 2005-11-14 17:52:09Z jalateras $
 */
...
public class AuditServiceException extends OpenVPMSException {
     ...
     *            the error code
     */
    public AuditServiceException(ErrorCode errorCode) {
     ...
     *            error code
     */
    public AuditServiceException(ErrorCode errorCode, Object[] params) {
     ...
     *            the root exception
     */
    public AuditServiceException(ErrorCode errorCode, Throwable cause) {
