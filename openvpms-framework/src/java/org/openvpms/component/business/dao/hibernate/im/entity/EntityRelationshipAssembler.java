...
/**
 * Assembles {@link EntityRelationship}s from {@link EntityRelationshipDO}s and vice-versa.
 *
 * @author Tim Anderson
 */
public class EntityRelationshipAssembler
     ...
     */
    @Override
    protected void assembleObject(EntityRelationship target, EntityRelationshipDO source, Context context) {
        super.assembleObject(target, source, context);
        EntityIdentity identity = getObject(source.getIdentity(), EntityIdentity.class, context);
        target.setIdentity(identity);
    }
