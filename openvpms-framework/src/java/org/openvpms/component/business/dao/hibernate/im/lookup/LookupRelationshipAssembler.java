...
/**
 * Assembles {@link LookupRelationship}s from {@link LookupRelationshipDO}s and vice-versa.
 *
 * @author Tim Anderson
 */
public class LookupRelationshipAssembler
        extends IMObjectRelationshipAssembler<LookupRelationship, LookupRelationshipDO> {

    /**
     * Constructs a {@link LookupRelationshipAssembler}.
     */
    public LookupRelationshipAssembler() {
        super(org.openvpms.component.model.lookup.LookupRelationship.class, LookupRelationship.class,
              LookupRelationshipDO.class, LookupRelationshipDOImpl.class, LookupDO.class, LookupDOImpl.class);
    }
