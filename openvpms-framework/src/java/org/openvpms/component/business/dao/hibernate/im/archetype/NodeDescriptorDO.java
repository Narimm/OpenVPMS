 ...
 */
public class NodeDescriptorDO extends DescriptorDO {
    /**
    ...
    public ArchetypeId getArchetypeId() {
        return (nodeDescriptors == null || nodeDescriptors.isEmpty()) ? NodeDescriptorDO.NODE : NodeDescriptorDO.COLLECTION_NODE;
    }
     ...
     */
    protected void setArchetypeDescriptor(ArchetypeDescriptorDO descriptor) {
     ...
     *               node has no parent
     */
    protected void setParent(NodeDescriptorDO parent) {
        this.parent = parent;
    }
