 ...
 *
 *  $Id: AuditDAOException.java 292 2005-10-28 02:25:05Z jalateras $
 */
...
/**
 * Used by the AuditRecord DAO.
 * 
 * @author <a href="mailto:support@openvpms.org">OpenVPMS Team</a>
 * @version $LastChangedDate: 2005-10-28 12:25:05 +1000 (Fri, 28 Oct 2005) $
 */
public class AuditDAOException extends RuntimeException implements
        OpenVPMSException {
    ...
    public enum ErrorCode {
        FailedToInsertAuditRecord,
        FailedToFindAuditRecordById, 
        FailedToFindAuditRecords
    }
    ...
    private static Messages messages = Messages
            .getMessages("org.openvpms.component.business.dao.im.audit."
     ...
     *            the error code
     */
    public AuditDAOException(ErrorCode errorCode) {
     ...
     *            error code
     */
    public AuditDAOException(ErrorCode errorCode, Object[] params) {
     ...
     *            the root exception
     */
    public AuditDAOException(ErrorCode errorCode, Throwable cause) {
