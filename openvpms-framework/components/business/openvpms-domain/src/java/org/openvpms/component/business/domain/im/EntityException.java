 ...
 */
public class EntityException extends RuntimeException implements
        OpenVPMSException {

    /**
     * Generated SUID
     */
    private static final long serialVersionUID = 2982134321674563540L;
    ...
    private static Messages messages = Messages
            .getMessages("org.openvpms.component.business.domain.im."
     ...
     *            error code
     */
    public EntityException(ErrorCode errorCode, Object[] params) {
