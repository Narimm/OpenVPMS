 ...
 */
public class JXPathBindingException extends RuntimeException implements
        OpenVPMSException {
    ...
    private static Messages messages = Messages
            .getMessages("org.openvpms.component.presentation.tapestry.binding."
     ...
     *            the error code
     */
    public JXPathBindingException(ErrorCode errorCode) {
     ...
     *            error code
     */
    public JXPathBindingException(ErrorCode errorCode, Object[] params) {
     ...
     *            the root exception
     */
    public JXPathBindingException(ErrorCode errorCode, Throwable cause) {
