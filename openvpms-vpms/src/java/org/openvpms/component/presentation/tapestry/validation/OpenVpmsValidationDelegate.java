 ...
 */
public class OpenVpmsValidationDelegate extends ValidationDelegate {
	/**
	 * Default SUID
	 */
	...
	public IFieldTracking getFieldTracking(String string) {
		if (getAssociatedTrackings() == null) {
			return null;
		}
		for (Iterator iter = getAssociatedTrackings().iterator(); iter
				.hasNext();) {
