...
then
    ...
    java -Dlog4j.configuration=file:../conf/log4j.properties -classpath $CLASSPATH org.openvpms.tools.data.loader.StaxArchetypeDataLoader -c ../conf/applicationContext.xml $* -b 1000
fi
