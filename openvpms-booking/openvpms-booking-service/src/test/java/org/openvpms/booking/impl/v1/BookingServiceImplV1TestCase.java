...
/**
 * Tests the {@link BookingServiceImplV1}.
 *
 * @author Tim Anderson
 */
public class BookingServiceImplV1TestCase extends ArchetypeServiceTest {
    ...
    public void testCancel() {
        ...
        BookingServiceV1 service = createBookingService(acts);
    ...
    public void testBackDatedAppointment() {
        ...
        Date endTime = DateRules.getDate(startTime, 45, DateUnits.MINUTES);
        Booking booking = createBooking(startTime, endTime);
        BookingServiceV1 service = createBookingService();
     ...
     */
    private BookingServiceV1 createBookingService() {
        return new BookingServiceImplV1(new BookingServiceImpl(getArchetypeService(), customerRules, appointmentRules,
     ...
     * @return the booking service
     */
    private BookingServiceV1 createBookingService(final List<Act> acts) {
        BookingService service = new BookingServiceImpl(getArchetypeService(), customerRules, appointmentRules,
                                                        userRules, transactionManager) {
            @Override
        ...
        return new BookingServiceImplV1(service);
    }
