...
/**
 * Implementation of {@link MergeHandler} for {@link Lookup}s.
 *
 * @author <a href="mailto:support@openvpms.org">OpenVPMS Team</a>
 * @version $LastChangedDate: 2006-05-02 05:16:31Z $
 */
class LookupMergeHandler extends AbstractMergeHandler {
    ...
    public IMObject merge(IMObject object, Session session) {
        ...
        save(lookup.getLookupRelationships(), session);
    ...
    public void update(IMObject target, IMObject source) {
        ...
        update(targetLookup.getLookupRelationships(),
               sourceLookup.getLookupRelationships());
