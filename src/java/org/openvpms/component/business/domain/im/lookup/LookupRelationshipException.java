 ...
 */
public class LookupRelationshipException extends RuntimeException implements
        OpenVPMSException {
    ...
    private static Messages messages = Messages
            .getMessages("org.openvpms.component.business.domain.im.lookup."
     ...
     *            the error code
     */
    public LookupRelationshipException(ErrorCode errorCode) {
     ...
     *            error code
     */
    public LookupRelationshipException(ErrorCode errorCode, Object[] params) {
     ...
     *            the root exception
     */
    public LookupRelationshipException(ErrorCode errorCode, Throwable cause) {
