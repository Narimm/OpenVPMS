...
public class JXPathHelperException extends OpenVPMSException {
     ...
     *            the error code
     */
    public JXPathHelperException(ErrorCode errorCode) {
     ...
     *            error code
     */
    public JXPathHelperException(ErrorCode errorCode, Object[] params) {
     ...
     *            the root exception
     */
    public JXPathHelperException(ErrorCode errorCode, Throwable cause) {
