...
public class ArchetypeDataLoader {
    ...
    /**
     * A reference to an XMLOutputter, which is used to format
     * XML data
     */
    ...
    private void processDir(String dir) throws Exception {
        ...
        Collection collection = FileUtils.listFiles(new File(dir), 
                extensions, subdir);
     ...
     * @return Document
     */
    private Document getData(String file) 
    throws Exception {
        if (data == null) {
    ...
    throws Exception {
        jsap.registerParameter(new FlaggedOption("dir")
                .setShortFlag('d')
                .setLongFlag("dir")
                .setHelp("Directory where data files reside."));
        ...
        jsap.registerParameter(new FlaggedOption("file")
                .setShortFlag('f')
                .setLongFlag("file")
                .setHelp("Name of file containing data"));
    ...
    private void displayUsage() {
        ...
        System.err.println("Usage: java "
                            + ArchetypeDataLoader.class.getName());
        System.err.println("                "
                            + jsap.getUsage());
        System.err.println();
