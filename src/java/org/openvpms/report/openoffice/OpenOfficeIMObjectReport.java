...
public class OpenOfficeIMObjectReport implements IMObjectReport {
    ...
    public Document generate(IMObject object) {
        ...
        try {
            ...
            XNameAccess namedFieldMasters = textFieldsSupplier.getTextFieldMasters();
            XEnumerationAccess enumeratedFields = textFieldsSupplier.getTextFields();
            ...
            throw new IMObjectReportException(e);
        }
    }
    ...
    protected XComponent newDocComponent(String docType)
        ...
        _serviceManager = this.getServiceManager();
        Object desktop = _serviceManager.createInstanceWithContext(
     ...
     */
    protected XComponent newDocComponentFromTemplate()
            throws com.sun.star.uno.Exception {
        // get the remote service manager
        _serviceManager = getServiceManager();
        ...
        return xComponentLoader.loadComponentFromURL("private:stream", "_blank",
                                                     0, properties);
    }

    private Document export(XComponent template) throws CloseVetoException,
                                                        IOException {
                XTextDocument aTextDocument = (XTextDocument) UnoRuntime.queryInterface(com.sun.star.text.XTextDocument.class, template);
        ...
        XModel xModel = (XModel) UnoRuntime.queryInterface(XModel.class, template);
