 ...
 */
public class OpenOfficeService implements com.sun.star.lang.XEventListener {
    ...
    /**
     * Constructs a new <code>OpenOfficeService</code>, specifying the connection
     * paramaters, e.g <code>socket,host=localhost,port=8100</code> for
     * a socket connection, or <code>pipe,name=oopipe</code> for a named pipe
     * connection.
     *
     * @param connectParams connection parameters
     */
    public OpenOfficeService(String connectParams) {
        _connectParams = connectParams;
        _protocolParams = "urp";
        _objectName = "StarOffice.ServiceManager";
    }
    ...
    private void connect() throws com.sun.star.uno.Exception, Exception {
        ...
        // get the XComponent interface and add this as an event listener
        XComponent component = (XComponent) getInterface(XComponent.class,
                                                         bridge);
        component.addEventListener(this);

        // get the remote instance
        Object object = bridge.getInstance(_objectName);
        if (object == null) {
            throw new com.sun.star.uno.Exception(
                    "Server didn't provide an instance for " + _objectName,
                    null);
        }

        // query the initial object for its main factory interface
        _componentFactory = (XMultiComponentFactory) getInterface(
        ...
        XPropertySet propertySet = (XPropertySet) getInterface(
                XPropertySet.class, _componentFactory);
        ...
        _componentContext = (XComponentContext) getInterface(
