...
/**
 * Used by the User DAO.
 * 
 * @author <a href="mailto:support@openvpms.org">OpenVPMS Team</a>
 * @version $LastChangedDate$
 */
public class UserDAOException extends OpenVPMSException {
    /**
     * Generated SUID.
     */
    ...
    private static Messages messages = Messages
            .getMessages("org.openvpms.component.business.dao.im.security."
     ...
     *            the error code
     */
    public UserDAOException(ErrorCode errorCode) {
     ...
     *            error code
     */
    public UserDAOException(ErrorCode errorCode, Object[] params) {
     ...
     *            the root exception
     */
    public UserDAOException(ErrorCode errorCode, Throwable cause) {
